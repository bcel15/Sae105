...
<main>
    ...
    <section>
        ...
        <p>Toute reproduction ou représentation, intégrale ou partielle, du contenu du site sans autorisation est interdite.</p>
    </section>

    <section>
        <h2>Copyright</h2>
        <p>Ce site respecte les lois françaises sur le droit d’auteur et la propriété intellectuelle.</p>
    </section>
</main>
