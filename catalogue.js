...
const descriptions = {
    ...
    parfum4: "Ambition, moderne et audacieux, reflète la personnalité des visionnaires de notre époque. Ses notes de poivre noir, de cuir et de patchouli confèrent au parfum une profondeur et une force qui symbolisent la réussite et l'aspiration.",
...
function addToCartFromPopup() {
    ...
    const price = parseFloat(priceText.replace(/[^\d.,-]/g, '').replace(',', '.').trim());
    addToCart(title, price, event);
}

// Afficher les détails d'un parfum
